...
if((i < len)){
var k = (ks[i]);
var G__13249 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__13250 = (i + (1));
m = G__13249;
i = G__13250;
continue;
...
var temp__5755__auto__ = p.argv;
if((temp__5755__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__13251 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__13251);
})());
} else {
var v = temp__5755__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13253 = c;
var G__13253__$1 = (((G__13253 == null))?null:G__13253.prototype);
if((G__13253__$1 == null)){
return null;
} else {
return G__13253__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13255 = c;
var G__13255__$1 = (((G__13255 == null))?null:G__13255.prototype);
if((G__13255__$1 == null)){
return null;
} else {
return G__13255__$1.render;
}
})() == null)))));
});
...
var G__13257 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13257) : reagent.impl.component.as_element.call(null,G__13257));
};
...
var G__13263 = c;
var G__13263__$1 = (((G__13263 == null))?null:G__13263.constructor);
if((G__13263__$1 == null)){
return null;
} else {
return G__13263__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__13264 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13265 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13265);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13264);
}});
...
var c = this;
var G__13269_13271 = goog.object.get(c,"cljsRatom");
if((G__13269_13271 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13269_13271);
}
...
var renders_13272 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_13273 = cljs.core.first(cljs.core.vals(renders_13272));
...
if((cljs.core.count(renders_13272) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13272))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13273)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13273], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__13274 = o;
goog.object.set(G__13274,cljs.core.name(k),v);
