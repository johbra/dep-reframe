...
var G__15186 = o;
goog.object.set(G__15186,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__15187__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__15187 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__15188__i = 0, G__15188__a = new Array(arguments.length -  0);
while (G__15188__i < G__15188__a.length) {G__15188__a[G__15188__i] = arguments[G__15188__i + 0]; ++G__15188__i;}
  args = new cljs.core.IndexedSeq(G__15188__a,0,null);
} 
return G__15187__delegate.call(this,args);};
G__15187.cljs$lang$maxFixedArity = 0;
G__15187.cljs$lang$applyTo = (function (arglist__15189){
var args = cljs.core.seq(arglist__15189);
return G__15187__delegate(args);
});
...
var G__15190 = o;
goog.object.set(G__15190,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__15191__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
return G__15191__delegate.call(this,args);};
...
return G__15191__delegate(args);
});
...
var G__15194 = props;
var G__15194__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__15194,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15194);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15194__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__15195 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15195,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__15195;
}
})(),id_class);
...
var G__15196 = (cljs.core.count.call(null,argv) - first_child);
switch (G__15196) {
case (0):
...
var vec__15198 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15198,(0),null);
var id = cljs.core.nth.call(null,vec__15198,(1),null);
var className = cljs.core.nth.call(null,vec__15198,(2),null);
...
var temp__5739__auto___15201 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___15201 == null)){
} else {
var key_15202 = temp__5739__auto___15201;
(jsprops.key = key_15202);
}
...
var temp__5739__auto___15203 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___15203 == null)){
} else {
var key_15204 = temp__5739__auto___15203;
(jsprops.key = key_15204);
}
...
var temp__5739__auto___15205 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___15205 == null)){
} else {
var key_15206 = temp__5739__auto___15205;
(jsprops.key = key_15206);
}
...
var temp__5739__auto___15207 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___15207 == null)){
} else {
var key_15208 = temp__5739__auto___15207;
(jsprops.key = key_15208);
}
...
var temp__5739__auto___15209 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___15209 == null)){
} else {
var key_15210 = temp__5739__auto___15209;
(jsprops.key = key_15210);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__15211_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__15211_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__15212 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__15212,(0),null);
var derefed = cljs.core.nth.call(null,vec__15212,(1),null);
...
break;
default:
var G__15217 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__15218 = compiler;
v = G__15217;
compiler = G__15218;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template15222 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template15222 = (function (opts,id,fn_to_element,meta15223){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template15222.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15224,meta15223__$1){
var self__ = this;
var _15224__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template15222(self__.opts,self__.id,self__.fn_to_element,meta15223__$1));
}));

(reagent.impl.template.t_reagent$impl$template15222.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15224){
var self__ = this;
var _15224__$1 = this;
return self__.meta15223;
}));

(reagent.impl.template.t_reagent$impl$template15222.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template15222.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template15222.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template15222.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template15222.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta15223","meta15223",-37624016,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template15222.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template15222.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template15222");

(reagent.impl.template.t_reagent$impl$template15222.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template15222");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template15222.
 */
reagent.impl.template.__GT_t_reagent$impl$template15222 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template15222(opts__$1,id__$1,fn_to_element__$1,meta15223){
return (new reagent.impl.template.t_reagent$impl$template15222(opts__$1,id__$1,fn_to_element__$1,meta15223));
});

}

return (new reagent.impl.template.t_reagent$impl$template15222(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
