...
var G__9390 = o;
goog.object.set(G__9390,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__9392__i < G__9392__a.length) {G__9392__a[G__9392__i] = arguments[G__9392__i + 0]; ++G__9392__i;}
  args = new cljs.core.IndexedSeq(G__9392__a,0,null);
} 
...
var G__9394 = o;
goog.object.set(G__9394,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__9398 = props;
var G__9398__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__9398,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9398);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9398__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__9399 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9399,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__9399;
}
})(),id_class);
...
var G__9400 = (cljs.core.count.call(null,argv) - first_child);
switch (G__9400) {
case (0):
...
var vec__9402 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__9402,(0),null);
var id = cljs.core.nth.call(null,vec__9402,(1),null);
var className = cljs.core.nth.call(null,vec__9402,(2),null);
...
var temp__5739__auto___9405 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___9405 == null)){
} else {
var key_9406 = temp__5739__auto___9405;
(jsprops.key = key_9406);
}
...
var temp__5739__auto___9407 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___9407 == null)){
} else {
var key_9408 = temp__5739__auto___9407;
(jsprops.key = key_9408);
}
...
var temp__5739__auto___9409 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___9409 == null)){
} else {
var key_9410 = temp__5739__auto___9409;
(jsprops.key = key_9410);
}
...
var temp__5739__auto___9411 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___9411 == null)){
} else {
var key_9412 = temp__5739__auto___9411;
(jsprops.key = key_9412);
}
...
var temp__5739__auto___9413 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___9413 == null)){
} else {
var key_9414 = temp__5739__auto___9413;
(jsprops.key = key_9414);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__9415_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__9415_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__9416 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__9416,(0),null);
var derefed = cljs.core.nth.call(null,vec__9416,(1),null);
...
break;
default:
var G__9421 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__9422 = compiler;
v = G__9421;
compiler = G__9422;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template9426 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template9426 = (function (opts,id,fn_to_element,meta9427){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template9426.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9428,meta9427__$1){
var self__ = this;
var _9428__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template9426(self__.opts,self__.id,self__.fn_to_element,meta9427__$1));
}));

(reagent.impl.template.t_reagent$impl$template9426.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9428){
var self__ = this;
var _9428__$1 = this;
return self__.meta9427;
}));

(reagent.impl.template.t_reagent$impl$template9426.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template9426.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template9426.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template9426.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template9426.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta9427","meta9427",-1595153589,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template9426.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template9426.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template9426");

(reagent.impl.template.t_reagent$impl$template9426.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template9426");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template9426.
 */
reagent.impl.template.__GT_t_reagent$impl$template9426 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template9426(opts__$1,id__$1,fn_to_element__$1,meta9427){
return (new reagent.impl.template.t_reagent$impl$template9426(opts__$1,id__$1,fn_to_element__$1,meta9427));
});

}

return (new reagent.impl.template.t_reagent$impl$template9426(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
