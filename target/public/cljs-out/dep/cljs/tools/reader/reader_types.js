...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13521 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13521(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13522 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13522(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13523 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13523(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13524 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13524(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13525 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13525(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13526 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13526(reader);
}
});
...
var G__13537 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13538 = s.append(c);
c = G__13537;
s = G__13538;
continue;
}
