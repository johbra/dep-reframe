...
var G__13603 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__13603;
continue;
} else {
return ch;
...
var vec__13604 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13604,(0),null);
return (match === s);
});
...
var len__4771__auto___13609 = arguments.length;
var i__4772__auto___13610 = (0);
while(true){
if((i__4772__auto___13610 < len__4771__auto___13609)){
args__4777__auto__.push((arguments[i__4772__auto___13610]));

var G__13611 = (i__4772__auto___13610 + (1));
i__4772__auto___13610 = G__13611;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq13607){
var G__13608 = cljs.core.first(seq13607);
var seq13607__$1 = cljs.core.next(seq13607);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13608,seq13607__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__13612__delegate = function (rdr,_){
...
var G__13612 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__13613__i = 0, G__13613__a = new Array(arguments.length -  1);
while (G__13613__i < G__13613__a.length) {G__13613__a[G__13613__i] = arguments[G__13613__i + 1]; ++G__13613__i;}
  _ = new cljs.core.IndexedSeq(G__13613__a,0,null);
} 
return G__13612__delegate.call(this,rdr,_);};
G__13612.cljs$lang$maxFixedArity = 1;
G__13612.cljs$lang$applyTo = (function (arglist__13614){
var rdr = cljs.core.first(arglist__13614);
var _ = cljs.core.rest(arglist__13614);
return G__13612__delegate(rdr,_);
});
