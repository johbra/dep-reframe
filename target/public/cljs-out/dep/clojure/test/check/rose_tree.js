...
return cljs.core.cons(cljs.core.first(s),(function (){var G__21146 = (n - (1));
var G__21147 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__21146,G__21147) : clojure.test.check.rose_tree.exclude_nth.call(null,G__21146,G__21147));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__21149 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__21149) : f.call(null,G__21149));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21148_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__21148_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__21148_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21150_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__21150_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__21150_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21151_SHARP_){
var G__21152 = clojure.test.check.rose_tree.root(p1__21151_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__21152) : pred.call(null,G__21152));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4529__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__21153(s__21154){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__21159 = cljs.core.first(xs__6292__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21159,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21159,(1),null);
var iterys__4525__auto__ = ((function (s__21154__$1,vec__21159,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__21153_$_iter__21155(s__21156){
return (new cljs.core.LazySeq(null,((function (s__21154__$1,vec__21159,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function (){
var s__21156__$1 = s__21156;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__21156__$1);
if(temp__5735__auto____$1){
var s__21156__$2 = temp__5735__auto____$1;
...
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__21157);
cljs.core.chunk_append(b__21158,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__21162 = (i__21157 + (1));
i__21157 = G__21162;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21158),clojure$test$check$rose_tree$permutations_$_iter__21153_$_iter__21155(cljs.core.chunk_rest(s__21156__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21158),null);
}
} else {
var child = cljs.core.first(s__21156__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__21153_$_iter__21155(cljs.core.rest(s__21156__$2)));
}
} else {
return null;
}
...
});})(s__21154__$1,vec__21159,rose,index,xs__6292__auto__,temp__5735__auto__))
,null,null));
});})(s__21154__$1,vec__21159,rose,index,xs__6292__auto__,temp__5735__auto__))
;
var fs__4526__auto__ = cljs.core.seq(iterys__4525__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4526__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4526__auto__,clojure$test$check$rose_tree$permutations_$_iter__21153(cljs.core.rest(s__21154__$1)));
} else {
var G__21163 = cljs.core.rest(s__21154__$1);
s__21154__$1 = G__21163;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21164_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__21164_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__21164_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21165_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__21165_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__21165_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__21166 = f;
var G__21167 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__21166,G__21167) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__21166,G__21167));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__21168 = f;
var G__21169 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__21168,G__21169) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__21168,G__21169));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
