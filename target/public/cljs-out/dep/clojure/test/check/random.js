...
var clojure$test$check$random$IRandom$rand_long$dyn_15959 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_15959.call(null,rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_15960 = (function (rng){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_15960.call(null,rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_15961 = (function (rng){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_15961.call(null,rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_15962 = (function (rng,n){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_15962.call(null,rng,n);
}
});
...
return clojure.test.check.random.longs.bit_xor.call(null,G__15963,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__15963;
}
});
...
var G__15966 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__15967 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__15966;
ret = G__15967;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.call(null,a,(function (p__15968){
...
var state = cljs.core.get.call(null,map__15969__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__15971 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__15971,(0),null);
var r2 = cljs.core.nth.call(null,vec__15971,(1),null);
