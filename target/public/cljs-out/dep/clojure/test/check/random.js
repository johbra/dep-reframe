...
var clojure$test$check$random$IRandom$rand_long$dyn_21755 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_21755.call(null,rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_21756 = (function (rng){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_21756.call(null,rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_21757 = (function (rng){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_21757.call(null,rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_21758 = (function (rng,n){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_21758.call(null,rng,n);
}
});
...
return clojure.test.check.random.longs.bit_xor.call(null,G__21759,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__21759;
}
});
...
var G__21762 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__21763 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__21762;
ret = G__21763;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.call(null,a,(function (p__21764){
var map__21765 = p__21764;
var map__21765__$1 = (((((!((map__21765 == null))))?(((((map__21765.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21765.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21765):map__21765);
var state = cljs.core.get.call(null,map__21765__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__21767 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__21767,(0),null);
var r2 = cljs.core.nth.call(null,vec__21767,(1),null);
