...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__31281 = cljs.core.second(format);
var G__31282 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__31281,G__31282) : ajax.easy.keyword_response_format_element.call(null,G__31281,G__31282));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31285_SHARP_){
return ajax.easy.keyword_response_format_element(p1__31285_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__31286){
var map__31287 = p__31286;
var map__31287__$1 = cljs.core.__destructure_map(map__31287);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31287__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31287__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31287__$1,cljs.core.cst$kw$finally);
...
return (function ajax$easy$transform_handler_$_easy_handler(p__31288){
var vec__31289 = p__31288;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31289,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31289,(1),null);
var fexpr__31292_31293 = (cljs.core.truth_(ok)?h:e);
(fexpr__31292_31293.cljs$core$IFn$_invoke$arity$1 ? fexpr__31292_31293.cljs$core$IFn$_invoke$arity$1(result) : fexpr__31292_31293.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__31294){
var map__31295 = p__31294;
var map__31295__$1 = cljs.core.__destructure_map(map__31295);
var opts = map__31295__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31295__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31295__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31295__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31295__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31295__$1,cljs.core.cst$kw$body);
