...
var G__31028 = request;
var G__31029 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__31028,G__31029) : ajax.formats.get_format.call(null,G__31028,G__31029));
} else {
...
return ajax.formats.content_type_matches(content_type,p1__31030_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__31031){
var map__31032 = p__31031;
var map__31032__$1 = cljs.core.__destructure_map(map__31032);
var request = map__31032__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31032__$1,cljs.core.cst$kw$response_DASH_format);
...
var fexpr__31033 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__31033.cljs$core$IFn$_invoke$arity$1 ? fexpr__31033.cljs$core$IFn$_invoke$arity$1(response) : fexpr__31033.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__31035){
var map__31036 = p__31035;
var map__31036__$1 = cljs.core.__destructure_map(map__31036);
var request = map__31036__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31036__$1,cljs.core.cst$kw$response_DASH_format);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__31034_SHARP_){
return ajax.formats.get_accept_entries(request,p1__31034_SHARP_);
