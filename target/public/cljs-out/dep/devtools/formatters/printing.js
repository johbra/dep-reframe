...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22487){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22488,G__22489,seq22487__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22493_SHARP_){
return (!((cljs.core.meta.call(null,p1__22493_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__22494__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22498){var _e__21723__auto__ = e22498;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e22500){var _e__21723__auto__ = e22500;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22502 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22503 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22503);

try{var map__22504 = opts;
var map__22504__$1 = (((((!((map__22504 == null))))?(((((map__22504.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22504.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22504):map__22504);
var markup_db = cljs.core.get.call(null,map__22504__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22502);
}});
...
var temp__5733__auto___22509 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___22509)){
var managed_print_level_22510 = temp__5733__auto___22509;
var _STAR_print_level_STAR__orig_val__22507_22511 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22508_22512 = managed_print_level_22510;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22508_22512);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22506_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22506_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22507_22511);
}} else {
job_fn.call(null);
}
