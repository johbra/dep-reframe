...
var G__28234 = devtools.prefs.pref.call(null,v);
v = G__28234;
continue;
} else {
return v;
...
}catch (e28237){var _e__27496__auto__ = e28237;
return false;
}})();
...
}catch (e28241){var _e__27496__auto__ = e28241;
return false;
}})();
...
}catch (e28243){var _e__27496__auto__ = e28243;
return false;
}}
}
});
...
var vec__28245 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28245,(0),null);
var name = cljs.core.nth.call(null,vec__28245,(1),null);
...
return cljs.core.some.call(null,(function (p1__28248_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28248_SHARP_);
}),template);
});
