...
var G__22461 = devtools.prefs.pref.call(null,v);
v = G__22461;
continue;
} else {
return v;
...
}catch (e22464){var _e__21723__auto__ = e22464;
return false;
}})();
...
}catch (e22468){var _e__21723__auto__ = e22468;
return false;
}})();
...
}catch (e22470){var _e__21723__auto__ = e22470;
return false;
}}
}
});
...
var vec__22472 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22472,(0),null);
var name = cljs.core.nth.call(null,vec__22472,(1),null);
...
return cljs.core.some.call(null,(function (p1__22475_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22475_SHARP_);
}),template);
});
