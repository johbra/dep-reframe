...
var G__28257 = devtools.prefs.pref.call(null,v);
v = G__28257;
continue;
} else {
return v;
...
}catch (e28260){var _e__27519__auto__ = e28260;
return false;
}})();
...
}catch (e28264){var _e__27519__auto__ = e28264;
return false;
}})();
...
}catch (e28266){var _e__27519__auto__ = e28266;
return false;
}}
}
});
...
var vec__28268 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28268,(0),null);
var name = cljs.core.nth.call(null,vec__28268,(1),null);
...
return cljs.core.some.call(null,(function (p1__28271_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28271_SHARP_);
}),template);
});
