...
var o28131 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28131["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28132 = temp__5733__auto____$1;
return (o28132["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27489__auto__ = f;
return (o__27489__auto__["toString"]).call(o__27489__auto__);
} else {
return "";
}
}catch (e28133){var _ = e28133;
return "";
}});
...
try{var o__27489__auto___28135 = t;
(o__27489__auto___28135["cljs$lang$ctorPrWriter"]).call(o__27489__auto___28135,t,writer);
}catch (e28134){var __28136 = e28134;
}
...
var char_code = (function (){var o__27489__auto__ = (new String(char$));
return (o__27489__auto__["charCodeAt"]).call(o__27489__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27489__auto__ = String;
return (o__27489__auto__["fromCharCode"]).call(o__27489__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28137 = num_code;
switch (G__28137) {
case (1):
return (185);
...
var o__27489__auto__ = String;
return (o__27489__auto__["fromCharCode"]).call(o__27489__auto__,superscript_code);
});
/**
...
}catch (e28139){var _e__27496__auto__ = e28139;
return false;
}})())){
...
var vec__28140 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28140,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28145){
var vec__28146 = p__28145;
var ns_detector = cljs.core.nth.call(null,vec__28146,(0),null);
...
var G__28152 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28153 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28152;
remaining_tokens = G__28153;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28143){
var G__28144 = cljs.core.first.call(null,seq28143);
var seq28143__$1 = cljs.core.next.call(null,seq28143);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28144,seq28143__$1);
}));
...
var vec__28157 = cljs.core.split_with.call(null,(function (p1__28156_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28156_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28157,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28157,(1),null);
...
var vec__28163 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28163,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28163,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28166 = cljs.core.rest.call(null,remaining_tokens);
var G__28167 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28166;
name_tokens = G__28167;
continue;
} else {
...
var vec__28170 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28170,(0),null);
var arity = cljs.core.nth.call(null,vec__28170,(1),null);
var vec__28173 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28173,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28173,(1),null);
var vec__28176 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28176,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28176,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28176,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28176,(3),null);
...
var vec__28182 = result;
var munged_ns = cljs.core.nth.call(null,vec__28182,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28182,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28182,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28182,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28182,(4),null);
var arity = cljs.core.nth.call(null,vec__28182,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28186 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__28186,(0),null);
var args = cljs.core.nth.call(null,vec__28186,(1),null);
var vec__28189 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28189,(0),null);
var name = cljs.core.nth.call(null,vec__28189,(1),null);
...
var G__28192 = (arity + (1));
var G__28193 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28194){
var vec__28195 = p__28194;
var arity = cljs.core.nth.call(null,vec__28195,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28195,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__28198_SHARP_){
return cljs.core.get.call(null,arities,p1__28198_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__28199_SHARP_){
return cljs.core.drop.call(null,(2),p1__28199_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___28206 = arguments.length;
var i__4737__auto___28207 = (0);
while(true){
if((i__4737__auto___28207 < len__4736__auto___28206)){
args__4742__auto__.push((arguments[i__4737__auto___28207]));

var G__28208 = (i__4737__auto___28207 + (1));
i__4737__auto___28207 = G__28208;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28202){
var vec__28203 = p__28202;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28203,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28200){
var G__28201 = cljs.core.first.call(null,seq28200);
var seq28200__$1 = cljs.core.next.call(null,seq28200);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28201,seq28200__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28211__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28211__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28211__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28211__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28212 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28212,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28212,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28212,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28212,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28212,(4),null);
var arity = cljs.core.nth.call(null,vec__28212,(5),null);
...
var o__27489__auto__ = f;
return (o__27489__auto__["getBasis"]).call(o__27489__auto__);
});
/**
...
}catch (e28216){var _e__27496__auto__ = e28216;
...
var G__28217 = (obj[cljs.core.first.call(null,path)]);
var G__28218 = cljs.core.rest.call(null,path);
obj = G__28217;
path = G__28218;
continue;
} else {
...
var _STAR_ = (function (accum,p__28219){
var vec__28220 = p__28219;
var bit = cljs.core.nth.call(null,vec__28220,(0),null);
var protocol = cljs.core.nth.call(null,vec__28220,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28223){
var vec__28224 = p__28223;
var ns = cljs.core.nth.call(null,vec__28224,(0),null);
var name = cljs.core.nth.call(null,vec__28224,(1),null);
var selector = cljs.core.nth.call(null,vec__28224,(2),null);
...
var post_process = (function (p__28228){
var vec__28229 = p__28228;
var munged_name = cljs.core.nth.call(null,vec__28229,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28229,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__28227_SHARP_){
return (obj[cljs.core.first.call(null,p1__28227_SHARP_)]);
}),sorted_matches);
