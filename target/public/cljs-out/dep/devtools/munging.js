...
var o22358 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22358["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22359 = temp__5733__auto____$1;
return (o22359["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21716__auto__ = f;
return (o__21716__auto__["toString"]).call(o__21716__auto__);
} else {
return "";
}
}catch (e22360){var _ = e22360;
return "";
}});
...
try{var o__21716__auto___22362 = t;
(o__21716__auto___22362["cljs$lang$ctorPrWriter"]).call(o__21716__auto___22362,t,writer);
}catch (e22361){var __22363 = e22361;
}
...
var char_code = (function (){var o__21716__auto__ = (new String(char$));
return (o__21716__auto__["charCodeAt"]).call(o__21716__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21716__auto__ = String;
return (o__21716__auto__["fromCharCode"]).call(o__21716__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22364 = num_code;
switch (G__22364) {
case (1):
return (185);
...
var o__21716__auto__ = String;
return (o__21716__auto__["fromCharCode"]).call(o__21716__auto__,superscript_code);
});
/**
...
}catch (e22366){var _e__21723__auto__ = e22366;
return false;
}})())){
...
var vec__22367 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22367,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22372){
var vec__22373 = p__22372;
var ns_detector = cljs.core.nth.call(null,vec__22373,(0),null);
...
var G__22379 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22380 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22379;
remaining_tokens = G__22380;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22370){
var G__22371 = cljs.core.first.call(null,seq22370);
var seq22370__$1 = cljs.core.next.call(null,seq22370);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22371,seq22370__$1);
}));
...
var vec__22384 = cljs.core.split_with.call(null,(function (p1__22383_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22383_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22384,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22384,(1),null);
...
var vec__22390 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22390,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22390,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22393 = cljs.core.rest.call(null,remaining_tokens);
var G__22394 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22393;
...
var vec__22397 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22397,(0),null);
var arity = cljs.core.nth.call(null,vec__22397,(1),null);
var vec__22400 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22400,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22400,(1),null);
var vec__22403 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22403,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22403,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22403,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22403,(3),null);
...
var vec__22409 = result;
var munged_ns = cljs.core.nth.call(null,vec__22409,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22409,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22409,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22409,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22409,(4),null);
var arity = cljs.core.nth.call(null,vec__22409,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__22413 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__22413,(0),null);
var args = cljs.core.nth.call(null,vec__22413,(1),null);
var vec__22416 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22416,(0),null);
var name = cljs.core.nth.call(null,vec__22416,(1),null);
...
var G__22419 = (arity + (1));
var G__22420 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22421){
var vec__22422 = p__22421;
var arity = cljs.core.nth.call(null,vec__22422,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22422,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22425_SHARP_){
return cljs.core.get.call(null,arities,p1__22425_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22426_SHARP_){
return cljs.core.drop.call(null,(2),p1__22426_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22429){
var vec__22430 = p__22429;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22430,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22427){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22438__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22438__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22438__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22438__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22439 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22439,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22439,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22439,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22439,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22439,(4),null);
var arity = cljs.core.nth.call(null,vec__22439,(5),null);
...
var o__21716__auto__ = f;
return (o__21716__auto__["getBasis"]).call(o__21716__auto__);
});
/**
...
}catch (e22443){var _e__21723__auto__ = e22443;
...
var G__22444 = (obj[cljs.core.first.call(null,path)]);
var G__22445 = cljs.core.rest.call(null,path);
obj = G__22444;
path = G__22445;
continue;
} else {
...
var _STAR_ = (function (accum,p__22446){
var vec__22447 = p__22446;
var bit = cljs.core.nth.call(null,vec__22447,(0),null);
var protocol = cljs.core.nth.call(null,vec__22447,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22450){
var vec__22451 = p__22450;
var ns = cljs.core.nth.call(null,vec__22451,(0),null);
var name = cljs.core.nth.call(null,vec__22451,(1),null);
var selector = cljs.core.nth.call(null,vec__22451,(2),null);
...
var post_process = (function (p__22455){
var vec__22456 = p__22455;
var munged_name = cljs.core.nth.call(null,vec__22456,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22456,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22454_SHARP_){
return (obj[cljs.core.first.call(null,p1__22454_SHARP_)]);
}),sorted_matches);
