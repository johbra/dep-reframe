...
var o33034 = temp__5733__auto__;
var temp__5733__auto____$1 = (o33034["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o33035 = temp__5733__auto____$1;
return (o33035["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__32392__auto__ = f;
return (o__32392__auto__["toString"]).call(o__32392__auto__);
} else {
return "";
}
}catch (e33036){var _ = e33036;
return "";
}});
...
try{var o__32392__auto___33038 = t;
(o__32392__auto___33038["cljs$lang$ctorPrWriter"]).call(o__32392__auto___33038,t,writer);
}catch (e33037){var __33039 = e33037;
}
...
var char_code = (function (){var o__32392__auto__ = (new String(char$));
return (o__32392__auto__["charCodeAt"]).call(o__32392__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__32392__auto__ = String;
return (o__32392__auto__["fromCharCode"]).call(o__32392__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__33040 = num_code;
switch (G__33040) {
case (1):
return (185);
...
var o__32392__auto__ = String;
return (o__32392__auto__["fromCharCode"]).call(o__32392__auto__,superscript_code);
});
/**
...
}catch (e33042){var _e__32399__auto__ = e33042;
return false;
}})())){
...
var vec__33043 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__33043,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__33048){
var vec__33049 = p__33048;
var ns_detector = cljs.core.nth.call(null,vec__33049,(0),null);
...
var G__33055 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__33056 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__33055;
remaining_tokens = G__33056;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq33046){
var G__33047 = cljs.core.first.call(null,seq33046);
var seq33046__$1 = cljs.core.next.call(null,seq33046);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33047,seq33046__$1);
}));
...
var vec__33060 = cljs.core.split_with.call(null,(function (p1__33059_SHARP_){
return cljs.core.not_EQ_.call(null,p1__33059_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__33060,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__33060,(1),null);
...
var vec__33066 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__33066,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__33066,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__33069 = cljs.core.rest.call(null,remaining_tokens);
var G__33070 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__33069;
name_tokens = G__33070;
continue;
} else {
...
var vec__33073 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__33073,(0),null);
var arity = cljs.core.nth.call(null,vec__33073,(1),null);
var vec__33076 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__33076,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__33076,(1),null);
var vec__33079 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__33079,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__33079,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__33079,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__33079,(3),null);
...
var vec__33085 = result;
var munged_ns = cljs.core.nth.call(null,vec__33085,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__33085,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__33085,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__33085,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__33085,(4),null);
var arity = cljs.core.nth.call(null,vec__33085,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__33089 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__33089,(0),null);
var args = cljs.core.nth.call(null,vec__33089,(1),null);
var vec__33092 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__33095 = (arity + (1));
var G__33096 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33097){
var vec__33098 = p__33097;
var arity = cljs.core.nth.call(null,vec__33098,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33098,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__33101_SHARP_){
return cljs.core.get.call(null,arities,p1__33101_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__33102_SHARP_){
return cljs.core.drop.call(null,(2),p1__33102_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33105){
var vec__33106 = p__33105;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33106,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33103){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33114__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33114__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33114__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33114__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33115 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33115,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33115,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33115,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33115,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33115,(4),null);
var arity = cljs.core.nth.call(null,vec__33115,(5),null);
...
var o__32392__auto__ = f;
return (o__32392__auto__["getBasis"]).call(o__32392__auto__);
});
/**
...
}catch (e33119){var _e__32399__auto__ = e33119;
...
var G__33120 = (obj[cljs.core.first.call(null,path)]);
var G__33121 = cljs.core.rest.call(null,path);
obj = G__33120;
path = G__33121;
continue;
} else {
...
var _STAR_ = (function (accum,p__33122){
var vec__33123 = p__33122;
var bit = cljs.core.nth.call(null,vec__33123,(0),null);
var protocol = cljs.core.nth.call(null,vec__33123,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33126){
var vec__33127 = p__33126;
var ns = cljs.core.nth.call(null,vec__33127,(0),null);
var name = cljs.core.nth.call(null,vec__33127,(1),null);
var selector = cljs.core.nth.call(null,vec__33127,(2),null);
...
var post_process = (function (p__33131){
var vec__33132 = p__33131;
var munged_name = cljs.core.nth.call(null,vec__33132,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__33132,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__33130_SHARP_){
return (obj[cljs.core.first.call(null,p1__33130_SHARP_)]);
}),sorted_matches);
