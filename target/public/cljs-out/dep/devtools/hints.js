...
var file = cljs.core.get.call(null,map__34208__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__34208__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
}catch (e34207){var _e = e34207;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___34210 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___34210)){
var seen_errors_34211 = temp__5733__auto___34210;
if(cljs.core.truth_(seen_errors_34211.has(self))){
} else {
seen_errors_34211.add(self);

var temp__5735__auto___34212 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___34212)){
var sense_34213 = temp__5735__auto___34212;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_34213)].join(''));
} else {
}
}
} else {
