...
re_com.simple_v_table.swap_BANG__sort_by_column = (function re_com$simple_v_table$swap_BANG__sort_by_column(p__24563,new_key_fn,new_comp){
var map__24564 = p__24563;
var map__24564__$1 = cljs.core.__destructure_map(map__24564);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24564__$1,cljs.core.cst$kw$key_DASH_fn);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24564__$1,cljs.core.cst$kw$order);
...
re_com.simple_v_table.column_header_item = (function re_com$simple_v_table$column_header_item(p__24565,parts,sort_by_column){
var map__24566 = p__24565;
var map__24566__$1 = cljs.core.__destructure_map(map__24566);
var column = map__24566__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24566__$1,cljs.core.cst$kw$id);
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24566__$1,cljs.core.cst$kw$row_DASH_label_DASH_fn);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24566__$1,cljs.core.cst$kw$width);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24566__$1,cljs.core.cst$kw$height);
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24566__$1,cljs.core.cst$kw$align);
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24566__$1,cljs.core.cst$kw$vertical_DASH_align);
var header_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24566__$1,cljs.core.cst$kw$header_DASH_label);
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24566__$1,cljs.core.cst$kw$sort_DASH_by);
var map__24567 = sort_by;
var map__24567__$1 = cljs.core.__destructure_map(map__24567);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24567__$1,cljs.core.cst$kw$key_DASH_fn,row_label_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24567__$1,cljs.core.cst$kw$comp,cljs.core.compare);
var map__24568 = cljs.core.deref(sort_by_column);
var map__24568__$1 = cljs.core.__destructure_map(map__24568);
var current_key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24568__$1,cljs.core.cst$kw$key_DASH_fn);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24568__$1,cljs.core.cst$kw$order);
...
return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$simple_DASH_column_DASH_header,cljs.core.cst$kw$attr], null))], 0))], null),(function (){var iter__4564__auto__ = (function re_com$simple_v_table$column_header_renderer_$_iter__24569(s__24570){
return (new cljs.core.LazySeq(null,(function (){
var s__24570__$1 = s__24570;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__24570__$1);
if(temp__5753__auto__){
var s__24570__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24570__$2)){
var c__4562__auto__ = cljs.core.chunk_first(s__24570__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__24572 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__24571 = (0);
while(true){
if((i__24571 < size__4563__auto__)){
var column = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4562__auto__,i__24571);
cljs.core.chunk_append(b__24572,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null));

var G__24573 = (i__24571 + (1));
i__24571 = G__24573;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24572),re_com$simple_v_table$column_header_renderer_$_iter__24569(cljs.core.chunk_rest(s__24570__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24572),null);
}
} else {
var column = cljs.core.first(s__24570__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null),re_com$simple_v_table$column_header_renderer_$_iter__24569(cljs.core.rest(s__24570__$2)));
}
} else {
return null;
}
 ...
 */
re_com.simple_v_table.row_item = (function re_com$simple_v_table$row_item(row,p__24574,cell_style,parts){
var map__24575 = p__24574;
var map__24575__$1 = cljs.core.__destructure_map(map__24575);
var column = map__24575__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24575__$1,cljs.core.cst$kw$width);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24575__$1,cljs.core.cst$kw$height);
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24575__$1,cljs.core.cst$kw$align);
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24575__$1,cljs.core.cst$kw$vertical_DASH_align);
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24575__$1,cljs.core.cst$kw$row_DASH_label_DASH_fn);
...
return null;
}):null)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$simple_DASH_row,cljs.core.cst$kw$attr], null))], 0))], null),(function (){var iter__4564__auto__ = (function re_com$simple_v_table$row_renderer_$_iter__24576(s__24577){
return (new cljs.core.LazySeq(null,(function (){
var s__24577__$1 = s__24577;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__24577__$1);
if(temp__5753__auto__){
var s__24577__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24577__$2)){
var c__4562__auto__ = cljs.core.chunk_first(s__24577__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__24579 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__24578 = (0);
while(true){
if((i__24578 < size__4563__auto__)){
var column = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4562__auto__,i__24578);
cljs.core.chunk_append(b__24579,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null));

var G__24580 = (i__24578 + (1));
i__24578 = G__24580;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24579),re_com$simple_v_table$row_renderer_$_iter__24576(cljs.core.chunk_rest(s__24577__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24579),null);
}
} else {
var column = cljs.core.first(s__24577__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null),re_com$simple_v_table$row_renderer_$_iter__24576(cljs.core.rest(s__24577__$2)));
}
} else {
return null;
}
...
re_com.simple_v_table.simple_v_table_parts_desc = ((re_com.config.include_args_desc_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_com.simple_v_table.simple_v_table_exclusive_parts_desc,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24581_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__24581_SHARP_,cljs.core.cst$kw$level,cljs.core.inc);
...
var len__4771__auto___24591 = arguments.length;
var i__4772__auto___24592 = (0);
while(true){
if((i__4772__auto___24592 < len__4771__auto___24591)){
args__4777__auto__.push((arguments[i__4772__auto___24592]));

var G__24593 = (i__4772__auto___24592 + (1));
i__4772__auto___24592 = G__24593;
continue;
} else {
}
break;
...
(re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic = (function (p__24585){
var map__24586 = p__24585;
var map__24586__$1 = cljs.core.__destructure_map(map__24586);
var args = map__24586__$1;
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24586__$1,cljs.core.cst$kw$src);
...
return (function() { 
var re_com$simple_v_table$simple_v_table_render__delegate = function (p__24587){
var map__24588 = p__24587;
var map__24588__$1 = cljs.core.__destructure_map(map__24588);
var args__$1 = map__24588__$1;
var cell_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$cell_DASH_style);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$model);
var on_leave_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$on_DASH_leave_DASH_row);
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$columns);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$parts);
var on_enter_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$on_DASH_enter_DASH_row);
var row_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24588__$1,cljs.core.cst$kw$row_DASH_height,(31));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$max_DASH_width);
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$src);
var on_click_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$on_DASH_click_DASH_row);
var table_row_line_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24588__$1,cljs.core.cst$kw$table_DASH_row_DASH_line_DASH_color,"#EAEEF1");
var table_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24588__$1,cljs.core.cst$kw$table_DASH_padding,(19));
var column_header_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24588__$1,cljs.core.cst$kw$column_DASH_header_DASH_height,(31));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$debug_DASH_as);
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$max_DASH_rows);
var row_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$row_DASH_style);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24588__$1,cljs.core.cst$kw$class);
var fixed_column_border_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24588__$1,cljs.core.cst$kw$fixed_DASH_column_DASH_border_DASH_color,"#BBBEC0");
var column_header_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24588__$1,cljs.core.cst$kw$column_DASH_header_DASH_renderer,re_com.simple_v_table.column_header_renderer);
var fixed_column_count = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24588__$1,cljs.core.cst$kw$fixed_DASH_column_DASH_count,(0));
...
var map__24589 = temp__5751__auto__;
var map__24589__$1 = cljs.core.__destructure_map(map__24589);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24589__$1,cljs.core.cst$kw$key_DASH_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24589__$1,cljs.core.cst$kw$comp,cljs.core.compare);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24589__$1,cljs.core.cst$kw$order);
...
while (G__24594__i < G__24594__a.length) {G__24594__a[G__24594__i] = arguments[G__24594__i + 0]; ++G__24594__i;}
  p__24587 = new cljs.core.IndexedSeq(G__24594__a,0,null);
} 
return re_com$simple_v_table$simple_v_table_render__delegate.call(this,p__24587);};
re_com$simple_v_table$simple_v_table_render.cljs$lang$maxFixedArity = 0;
re_com$simple_v_table$simple_v_table_render.cljs$lang$applyTo = (function (arglist__24595){
var p__24587 = cljs.core.seq(arglist__24595);
return re_com$simple_v_table$simple_v_table_render__delegate(p__24587);
});
...
/** @this {Function} */
(re_com.simple_v_table.simple_v_table.cljs$lang$applyTo = (function (seq24584){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq24584));
}));
