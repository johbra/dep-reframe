...
var len__4771__auto___24209 = arguments.length;
var i__4772__auto___24210 = (0);
while(true){
if((i__4772__auto___24210 < len__4771__auto___24209)){
args__4777__auto__.push((arguments[i__4772__auto___24210]));

var G__24211 = (i__4772__auto___24210 + (1));
i__4772__auto___24210 = G__24211;
continue;
} else {
}
break;
...
(re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__24206){
var map__24207 = p__24206;
var map__24207__$1 = cljs.core.__destructure_map(map__24207);
var args = map__24207__$1;
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$closeable_QMARK_);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$body);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$attr);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$heading);
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$on_DASH_close);
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24207__$1,cljs.core.cst$kw$alert_DASH_type,cljs.core.cst$kw$info);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$parts);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$style);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$id);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$class);
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24207__$1,cljs.core.cst$kw$padding);
...
var alert_class = (function (){var G__24208 = new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$none,"",cljs.core.cst$kw$info,"alert-success",cljs.core.cst$kw$warning,"alert-warning",cljs.core.cst$kw$danger,"alert-danger"], null);
return (alert_type.cljs$core$IFn$_invoke$arity$1 ? alert_type.cljs$core$IFn$_invoke$arity$1(G__24208) : alert_type.call(null,G__24208));
})();
...
})())?close_alert:null)], null)], null):null),(cljs.core.truth_(body)?new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.h_box,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Google-Drive/Planung/Clojure-Script/dep-reframe/target/public/cljs-out/dep/re_com/alert.cljs",cljs.core.cst$kw$line,92], null)),cljs.core.cst$kw$justify,cljs.core.cst$kw$between,cljs.core.cst$kw$align,cljs.core.cst$kw$center,cljs.core.cst$kw$class,["rc-alert-body ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$body,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$body,cljs.core.cst$kw$style], null),cljs.core.PersistentArrayMap.EMPTY),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$body,cljs.core.cst$kw$attr], null),cljs.core.PersistentArrayMap.EMPTY),cljs.core.cst$kw$children,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,body], null),(cljs.core.truth_(((cljs.core.not(heading))?(function (){var and__4149__auto__ = closeable_QMARK_;
if(cljs.core.truth_(and__4149__auto__)){
return on_close;
} else {
return and__4149__auto__;
...
/** @this {Function} */
(re_com.alert.alert_box.cljs$lang$applyTo = (function (seq24205){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq24205));
}));
...
var args__4777__auto__ = [];
var len__4771__auto___24221 = arguments.length;
var i__4772__auto___24222 = (0);
while(true){
if((i__4772__auto___24222 < len__4771__auto___24221)){
args__4777__auto__.push((arguments[i__4772__auto___24222]));

var G__24223 = (i__4772__auto___24222 + (1));
i__4772__auto___24222 = G__24223;
continue;
} else {
}
break;
...
(re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__24213){
var map__24214 = p__24213;
var map__24214__$1 = cljs.core.__destructure_map(map__24214);
var args = map__24214__$1;
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$attr);
var border_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$border_DASH_style);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$max_DASH_height);
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$on_DASH_close);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$parts);
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$src);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$style);
var alert_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$alert_DASH_style);
var alert_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$alert_DASH_class);
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$debug_DASH_as);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$class);
var alerts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24214__$1,cljs.core.cst$kw$alerts);
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24214__$1,cljs.core.cst$kw$padding,"4px");
...
})(),cljs.core.cst$kw$class,["rc-alert-list-wrapper ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$style], null),cljs.core.PersistentArrayMap.EMPTY),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$attr], null),cljs.core.PersistentArrayMap.EMPTY),cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.border,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Google-Drive/Planung/Clojure-Script/dep-reframe/target/public/cljs-out/dep/re_com/alert.cljs",cljs.core.cst$kw$line,160], null)),cljs.core.cst$kw$class,["rc-alert-list ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)].join(''),cljs.core.cst$kw$style,style,cljs.core.cst$kw$attr,attr,cljs.core.cst$kw$padding,padding,cljs.core.cst$kw$border,border_style,cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.scroller,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Google-Drive/Planung/Clojure-Script/dep-reframe/target/public/cljs-out/dep/re_com/alert.cljs",cljs.core.cst$kw$line,167], null)),cljs.core.cst$kw$v_DASH_scroll,cljs.core.cst$kw$auto,cljs.core.cst$kw$class,["rc-alert-list-scroller ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scroller,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$max_DASH_height,max_height], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scroller,cljs.core.cst$kw$style], null))], 0)),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scroller,cljs.core.cst$kw$attr], null)),cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.v_box,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Google-Drive/Planung/Clojure-Script/dep-reframe/target/public/cljs-out/dep/re_com/alert.cljs",cljs.core.cst$kw$line,174], null)),cljs.core.cst$kw$size,"auto",cljs.core.cst$kw$class,["rc-alert-list-v-box ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$v_DASH_box,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$v_DASH_box,cljs.core.cst$kw$style], null)),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$v_DASH_box,cljs.core.cst$kw$attr], null)),cljs.core.cst$kw$children,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4564__auto__ = (function re_com$alert$iter__24215(s__24216){
return (new cljs.core.LazySeq(null,(function (){
var s__24216__$1 = s__24216;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__24216__$1);
if(temp__5753__auto__){
var s__24216__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24216__$2)){
var c__4562__auto__ = cljs.core.chunk_first(s__24216__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__24218 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__24217 = (0);
while(true){
if((i__24217 < size__4563__auto__)){
var alert = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4562__auto__,i__24217);
cljs.core.chunk_append(b__24218,(function (){var map__24219 = alert;
var map__24219__$1 = cljs.core.__destructure_map(map__24219);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24219__$1,cljs.core.cst$kw$id);
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24219__$1,cljs.core.cst$kw$alert_DASH_type);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24219__$1,cljs.core.cst$kw$heading);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24219__$1,cljs.core.cst$kw$body);
var padding__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24219__$1,cljs.core.cst$kw$padding);
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24219__$1,cljs.core.cst$kw$closeable_QMARK_);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24218),re_com$alert$iter__24215(cljs.core.chunk_rest(s__24216__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24218),null);
}
} else {
var alert = cljs.core.first(s__24216__$2);
return cljs.core.cons((function (){var map__24220 = alert;
var map__24220__$1 = cljs.core.__destructure_map(map__24220);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24220__$1,cljs.core.cst$kw$id);
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24220__$1,cljs.core.cst$kw$alert_DASH_type);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24220__$1,cljs.core.cst$kw$heading);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24220__$1,cljs.core.cst$kw$body);
var padding__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24220__$1,cljs.core.cst$kw$padding);
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24220__$1,cljs.core.cst$kw$closeable_QMARK_);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 21, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.alert.alert_box,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Google-Drive/Planung/Clojure-Script/dep-reframe/target/public/cljs-out/dep/re_com/alert.cljs",cljs.core.cst$kw$line,182], null)),cljs.core.cst$kw$id,id,cljs.core.cst$kw$alert_DASH_type,alert_type,cljs.core.cst$kw$heading,heading,cljs.core.cst$kw$body,body,cljs.core.cst$kw$padding,padding__$1,cljs.core.cst$kw$closeable_QMARK_,closeable_QMARK_,cljs.core.cst$kw$on_DASH_close,on_close,cljs.core.cst$kw$class,alert_class,cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([alert_style,cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(alert)], 0))], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,id], null));
})(),re_com$alert$iter__24215(cljs.core.rest(s__24216__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(re_com.alert.alert_list.cljs$lang$applyTo = (function (seq24212){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq24212));
}));
