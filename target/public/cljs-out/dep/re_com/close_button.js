...
return (function() { 
var re_com$close_button$close_button_$_close_button_render__delegate = function (p__19643){
...
var args = map__19644__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$disabled_QMARK_);
var tooltip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$tooltip);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$attr);
var left_offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$left_DASH_offset);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19644__$1,cljs.core.cst$kw$color,"#ccc");
var font_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19644__$1,cljs.core.cst$kw$font_DASH_size,(16));
var div_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19644__$1,cljs.core.cst$kw$div_DASH_size,(16));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$parts);
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$src);
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$on_DASH_click);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$style);
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$debug_DASH_as);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$class);
var top_offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19644__$1,cljs.core.cst$kw$top_DASH_offset);
var hover_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19644__$1,cljs.core.cst$kw$hover_DASH_color,"#999");
var or__4126__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.close_button.close_button_args_desc),args));
...
})(),cljs.core.cst$kw$class,["rc-close-button ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$display,"inline-block",cljs.core.cst$kw$position,"relative",cljs.core.cst$kw$width,re_com.util.px(div_size),cljs.core.cst$kw$height,re_com.util.px(div_size)], null),(cljs.core.truth_(disabled_QMARK___$1)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$pointer_DASH_events,"none"], null):null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$style], null))], 0)),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$wrapper,cljs.core.cst$kw$attr], null)),cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Google-Drive/Planung/Clojure-Script/dep-reframe/target/public/cljs-out/dep/re_com/close_button.cljs",cljs.core.cst$kw$line,61], null)),cljs.core.cst$kw$class,class$,cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$position,"absolute",cljs.core.cst$kw$cursor,(cljs.core.truth_(disabled_QMARK___$1)?null:"pointer"),cljs.core.cst$kw$font_DASH_size,re_com.util.px(font_size),cljs.core.cst$kw$color,(cljs.core.truth_(cljs.core.deref(over_QMARK_))?hover_color:color),cljs.core.cst$kw$top,re_com.util.px.cljs$core$IFn$_invoke$arity$variadic((((font_size - div_size) / (2)) - top_offset),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$negative], 0)),cljs.core.cst$kw$left,re_com.util.px.cljs$core$IFn$_invoke$arity$variadic((((font_size - div_size) / (2)) - left_offset),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$negative], 0))], null),style], 0)),cljs.core.cst$kw$attr,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$title,tooltip,cljs.core.cst$kw$on_DASH_click,(function (event){
...
while (G__19646__i < G__19646__a.length) {G__19646__a[G__19646__i] = arguments[G__19646__i + 0]; ++G__19646__i;}
  p__19643 = new cljs.core.IndexedSeq(G__19646__a,0,null);
} 
return re_com$close_button$close_button_$_close_button_render__delegate.call(this,p__19643);};
re_com$close_button$close_button_$_close_button_render.cljs$lang$maxFixedArity = 0;
re_com$close_button$close_button_$_close_button_render.cljs$lang$applyTo = (function (arglist__19647){
var p__19643 = cljs.core.seq(arglist__19647);
return re_com$close_button$close_button_$_close_button_render__delegate(p__19643);
});
