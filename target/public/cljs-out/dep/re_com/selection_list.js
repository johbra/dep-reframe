...
var G__24632_24633 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__24632_24633) : on_change.call(null,G__24632_24633));
}

return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$list_DASH_group_DASH_item,cljs.core.cst$kw$attr], null))], 0)),cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 19, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.checkbox.checkbox,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Google-Drive/Planung/Clojure-Script/dep-reframe/target/public/cljs-out/dep/re_com/selection_list.cljs",cljs.core.cst$kw$line,52], null)),cljs.core.cst$kw$class,["rc-selection-list-checkbox ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$checkbox,cljs.core.cst$kw$class], null)))].join(''),cljs.core.cst$kw$style,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$checkbox,cljs.core.cst$kw$style], null)),cljs.core.cst$kw$attr,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$checkbox,cljs.core.cst$kw$attr], null)),cljs.core.cst$kw$model,(!(((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id)) == null))),cljs.core.cst$kw$on_DASH_change,(function (){
...
var len__4771__auto___24642 = arguments.length;
var i__4772__auto___24643 = (0);
while(true){
if((i__4772__auto___24643 < len__4771__auto___24642)){
args__4777__auto__.push((arguments[i__4772__auto___24643]));

var G__24644 = (i__4772__auto___24643 + (1));
i__4772__auto___24643 = G__24644;
continue;
} else {
}
break;
...
(re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__24640){
var map__24641 = p__24640;
var map__24641__$1 = cljs.core.__destructure_map(map__24641);
var args = map__24641__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24641__$1,cljs.core.cst$kw$disabled_QMARK_,false);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$on_DASH_change);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$height);
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$item_DASH_renderer);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$model);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$attr);
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24641__$1,cljs.core.cst$kw$label_DASH_fn,cljs.core.cst$kw$label);
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24641__$1,cljs.core.cst$kw$required_QMARK_,false);
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24641__$1,cljs.core.cst$kw$as_DASH_exclusions_QMARK_,false);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$max_DASH_height);
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24641__$1,cljs.core.cst$kw$hide_DASH_border_QMARK_,false);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$parts);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$width);
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$src);
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$choices);
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24641__$1,cljs.core.cst$kw$id_DASH_fn,cljs.core.cst$kw$id);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$style);
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$debug_DASH_as);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24641__$1,cljs.core.cst$kw$class);
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24641__$1,cljs.core.cst$kw$multi_DASH_select_QMARK_,true);
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer__$1)?(function (p1__24636_SHARP_){
return (item_renderer__$1.cljs$core$IFn$_invoke$arity$8 ? item_renderer__$1.cljs$core$IFn$_invoke$arity$8(p1__24636_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1) : item_renderer__$1.call(null,p1__24636_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1));
}):(cljs.core.truth_(multi_select_QMARK___$1)?(function (p1__24637_SHARP_){
return re_com.selection_list.as_checked(p1__24637_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1,parts);
}):(function (p1__24638_SHARP_){
return re_com.selection_list.as_radio(p1__24638_SHARP_,id_fn,selected,on_change__$1,disabled_QMARK___$1,label_fn,required_QMARK___$1,as_exclusions_QMARK___$1,parts);
}))),choices__$1);
...
/** @this {Function} */
(re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq24639){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq24639));
}));
