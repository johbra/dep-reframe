...
var len__4771__auto___19951 = arguments.length;
var i__4772__auto___19952 = (0);
while(true){
if((i__4772__auto___19952 < len__4771__auto___19951)){
args__4777__auto__.push((arguments[i__4772__auto___19952]));

var G__19953 = (i__4772__auto___19952 + (1));
i__4772__auto___19952 = G__19953;
continue;
} else {
}
break;
...
(re_com.input_text.input_text_base.cljs$core$IFn$_invoke$arity$variadic = (function (p__19939){
var map__19940 = p__19939;
var map__19940__$1 = cljs.core.__destructure_map(map__19940);
var args = map__19940__$1;
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19940__$1,cljs.core.cst$kw$model);
var input_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19940__$1,cljs.core.cst$kw$input_DASH_type);
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19940__$1,cljs.core.cst$kw$src);
...
return (function() { 
var re_com$input_text$input_text_base_render__delegate = function (p__19941){
var map__19942 = p__19941;
var map__19942__$1 = cljs.core.__destructure_map(map__19942);
var args__$1 = map__19942__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$disabled_QMARK_);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$on_DASH_change);
var status_icon_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$status_DASH_icon_QMARK_);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$height);
var status_tooltip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$status_DASH_tooltip);
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$model);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$attr);
var on_alter = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19942__$1,cljs.core.cst$kw$on_DASH_alter,cljs.core.identity);
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$placeholder);
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$parts);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$width);
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$src);
var rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$rows);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$style);
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$debug_DASH_as);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$status);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$class);
var change_on_blur_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19942__$1,cljs.core.cst$kw$change_DASH_on_DASH_blur_QMARK_,true);
var validation_regex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19942__$1,cljs.core.cst$kw$validation_DASH_regex);
...
var G__19943 = cljs.core.deref(internal_model);
var G__19944 = reset_fn;
return (on_change.cljs$core$IFn$_invoke$arity$2 ? on_change.cljs$core$IFn$_invoke$arity$2(G__19943,G__19944) : on_change.call(null,G__19943,G__19944));
} else {
var G__19945_19954 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__19945_19954) : on_change.call(null,G__19945_19954));
...
return null;
}),(function (){var G__19948 = input_type;
...
var G__19949_19957 = event.which;
switch (G__19949_19957) {
case (13):
on_change_handler();
...
var new_val_orig_19959 = event.target.value;
var new_val_19960 = (on_alter.cljs$core$IFn$_invoke$arity$1 ? on_alter.cljs$core$IFn$_invoke$arity$1(new_val_orig_19959) : on_alter.call(null,new_val_orig_19959));
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new_val_19960,new_val_orig_19959)){
(event.target.value = new_val_19960);
} else {
}
...
return cljs.core.re_find(validation_regex,new_val_19960);
} else {
return true;
}
} else {
...
cljs.core.reset_BANG_(internal_model,new_val_19960);
...
})())?(function (){var icon_class = (function (){var G__19950 = status;
...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.throbber.throbber,cljs.core.cst$kw$src,(((!(goog.DEBUG)))?null:new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$file,"/Users/jb/Google-Drive/Planung/Clojure-Script/dep-reframe/target/public/cljs-out/dep/re_com/input_text.cljs",cljs.core.cst$kw$line,190], null)),cljs.core.cst$kw$size,cljs.core.cst$kw$regular,cljs.core.cst$kw$class,"smaller"], null);
} else {
...
while (G__19962__i < G__19962__a.length) {G__19962__a[G__19962__i] = arguments[G__19962__i + 0]; ++G__19962__i;}
  p__19941 = new cljs.core.IndexedSeq(G__19962__a,0,null);
} 
return re_com$input_text$input_text_base_render__delegate.call(this,p__19941);};
re_com$input_text$input_text_base_render.cljs$lang$maxFixedArity = 0;
re_com$input_text$input_text_base_render.cljs$lang$applyTo = (function (arglist__19963){
var p__19941 = cljs.core.seq(arglist__19963);
return re_com$input_text$input_text_base_render__delegate(p__19941);
});
...
/** @this {Function} */
(re_com.input_text.input_text_base.cljs$lang$applyTo = (function (seq19938){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19938));
}));

re_com.input_text.input_text = (function re_com$input_text$input_text(var_args){
var args__4777__auto__ = [];
var len__4771__auto___19965 = arguments.length;
var i__4772__auto___19966 = (0);
while(true){
if((i__4772__auto___19966 < len__4771__auto___19965)){
args__4777__auto__.push((arguments[i__4772__auto___19966]));

var G__19967 = (i__4772__auto___19966 + (1));
i__4772__auto___19966 = G__19967;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_com.input_text.input_text.cljs$lang$applyTo = (function (seq19964){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19964));
}));

re_com.input_text.input_password = (function re_com$input_text$input_password(var_args){
var args__4777__auto__ = [];
var len__4771__auto___19969 = arguments.length;
var i__4772__auto___19970 = (0);
while(true){
if((i__4772__auto___19970 < len__4771__auto___19969)){
args__4777__auto__.push((arguments[i__4772__auto___19970]));

var G__19971 = (i__4772__auto___19970 + (1));
i__4772__auto___19970 = G__19971;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_com.input_text.input_password.cljs$lang$applyTo = (function (seq19968){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19968));
}));

re_com.input_text.input_textarea = (function re_com$input_text$input_textarea(var_args){
var args__4777__auto__ = [];
var len__4771__auto___19973 = arguments.length;
var i__4772__auto___19974 = (0);
while(true){
if((i__4772__auto___19974 < len__4771__auto___19973)){
args__4777__auto__.push((arguments[i__4772__auto___19974]));

var G__19975 = (i__4772__auto___19974 + (1));
i__4772__auto___19974 = G__19975;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_com.input_text.input_textarea.cljs$lang$applyTo = (function (seq19972){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19972));
}));
