...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__24607_SHARP_,p2__24608_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__24607_SHARP_,p2__24608_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4564__auto__ = (function re_com$tour$initialise_tour_$_iter__24609(s__24610){
return (new cljs.core.LazySeq(null,(function (){
var s__24610__$1 = s__24610;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__24610__$1);
if(temp__5753__auto__){
var s__24610__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24610__$2)){
var c__4562__auto__ = cljs.core.chunk_first(s__24610__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__24612 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__24611 = (0);
while(true){
if((i__24611 < size__4563__auto__)){
var step = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4562__auto__,i__24611);
cljs.core.chunk_append(b__24612,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24612),re_com$tour$initialise_tour_$_iter__24609(cljs.core.chunk_rest(s__24610__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24612),null);
}
} else {
var step = cljs.core.first(s__24610__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__24609(cljs.core.rest(s__24610__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__24614 = cljs.core.first(cljs.core.cst$kw$steps.cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__24614.cljs$core$IFn$_invoke$arity$1 ? fexpr__24614.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__24614.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__24615 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__24615.cljs$core$IFn$_invoke$arity$1 ? fexpr__24615.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__24615.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__24616 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__24616.cljs$core$IFn$_invoke$arity$1 ? fexpr__24616.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__24616.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__24617 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__24617.cljs$core$IFn$_invoke$arity$1 ? fexpr__24617.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__24617.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__24618 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__24618.cljs$core$IFn$_invoke$arity$1 ? fexpr__24618.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__24618.call(null,tour));
})(),true);
} else {
return null;
}
