...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.call(null,(function (p1__31157_SHARP_){
return cljs.core.seq.call(null,modulliste.call(null,p1__31157_SHARP_));
}),cljs.core.map.call(null,(function (mpl){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [mpl,cljs.core.filter.call(null,(function (p1__31158_SHARP_){
return dep.model.modul.mussModulUnterrichtetWerdenFuer_inQuartal_QMARK_.call(null,p1__31158_SHARP_,mpl,quartal);
}),module)], null);
}),manipels)));
});
/**
...
return cljs.core.map.call(null,(function (p1__31159_SHARP_){
return dep.model.lehrveranstaltung.__GT_Lehrveranstaltung.call(null,p1__31159_SHARP_,quartal,"NN",(1),cljs.core.key.call(null,ml));
...
return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__31160_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__31160_SHARP_),id);
}),lven));
});
/**
