...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__24133_SHARP_){
return cljs.core.seq((modulliste.cljs$core$IFn$_invoke$arity$1 ? modulliste.cljs$core$IFn$_invoke$arity$1(p1__24133_SHARP_) : modulliste.call(null,p1__24133_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (mpl){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [mpl,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__24134_SHARP_){
return dep.model.modul.mussModulUnterrichtetWerdenFuer_inQuartal_QMARK_(p1__24134_SHARP_,mpl,quartal);
}),module)], null);
}),manipels)));
});
/**
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24135_SHARP_){
return dep.model.lehrveranstaltung.__GT_Lehrveranstaltung(p1__24135_SHARP_,quartal,"NN",(1),cljs.core.key(ml));
}),cljs.core.val(ml));
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__24136_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__24136_SHARP_),id);
}),lven));
});
/**
