...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29266_SHARP_){
return dep.model.manipel.wirdUnterrichtetIn_QMARK_(p1__29266_SHARP_,quartal);
}),manipels);
});
/**
...
var sem = (function (){var G__29268 = dep.model.quartal.minus(quartal,cljs.core.cst$kw$studienbeginn.cljs$core$IFn$_invoke$arity$1(manipel));
var fexpr__29267 = cljs.core.cst$kw$jahrSemesterZuordnung.cljs$core$IFn$_invoke$arity$1(manipel);
return (fexpr__29267.cljs$core$IFn$_invoke$arity$1 ? fexpr__29267.cljs$core$IFn$_invoke$arity$1(G__29268) : fexpr__29267.call(null,G__29268));
})();
...
return cljs.core.key(cljs.core.first(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29269_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.val(p1__29269_SHARP_),semester);
}),jsz))));
});
/**
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29270_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(p1__29270_SHARP_),string);
}),manipels));
});
