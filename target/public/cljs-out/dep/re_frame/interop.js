...
return [(function (){var pred__13475 = cljs.core.instance_QMARK_;
var expr__13476 = reactive_val;
if(cljs.core.truth_((pred__13475.cljs$core$IFn$_invoke$arity$2 ? pred__13475.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__13476) : pred__13475.call(null,reagent.ratom.RAtom,expr__13476)))){
return "ra";
} else {
if(cljs.core.truth_((pred__13475.cljs$core$IFn$_invoke$arity$2 ? pred__13475.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__13476) : pred__13475.call(null,reagent.ratom.RCursor,expr__13476)))){
return "rc";
} else {
if(cljs.core.truth_((pred__13475.cljs$core$IFn$_invoke$arity$2 ? pred__13475.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__13476) : pred__13475.call(null,reagent.ratom.Reaction,expr__13476)))){
return "rx";
} else {
if(cljs.core.truth_((pred__13475.cljs$core$IFn$_invoke$arity$2 ? pred__13475.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__13476) : pred__13475.call(null,reagent.ratom.Track,expr__13476)))){
return "tr";
} else {
return "other";
}
