...
return [(function (){var pred__13477 = cljs.core.instance_QMARK_;
var expr__13478 = reactive_val;
if(cljs.core.truth_((pred__13477.cljs$core$IFn$_invoke$arity$2 ? pred__13477.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__13478) : pred__13477.call(null,reagent.ratom.RAtom,expr__13478)))){
return "ra";
} else {
if(cljs.core.truth_((pred__13477.cljs$core$IFn$_invoke$arity$2 ? pred__13477.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__13478) : pred__13477.call(null,reagent.ratom.RCursor,expr__13478)))){
return "rc";
} else {
if(cljs.core.truth_((pred__13477.cljs$core$IFn$_invoke$arity$2 ? pred__13477.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__13478) : pred__13477.call(null,reagent.ratom.Reaction,expr__13478)))){
return "rx";
} else {
if(cljs.core.truth_((pred__13477.cljs$core$IFn$_invoke$arity$2 ? pred__13477.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__13478) : pred__13477.call(null,reagent.ratom.Track,expr__13478)))){
return "tr";
} else {
return "other";
}
