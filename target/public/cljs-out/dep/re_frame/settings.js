...
re_frame.settings.reg_global_interceptor = (function re_frame$settings$reg_global_interceptor(p__29862){
var map__29863 = p__29862;
var map__29863__$1 = cljs.core.__destructure_map(map__29863);
var interceptor = map__29863__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29863__$1,cljs.core.cst$kw$id);
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(re_frame.settings.store,cljs.core.update,cljs.core.cst$kw$global_DASH_interceptors,(function (global_interceptors){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_frame.interop.empty_queue,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__29864_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__29864_SHARP_));
}),global_interceptors));
}));
}));
