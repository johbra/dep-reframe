...
var periods__$1 = cljs.core.vec((function (){var G__24258 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24257_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__24257_SHARP_,(0),(3));
}),G__24258);
} else {
return G__24258;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__24267){
var vec__24268 = p__24267;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24268,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24268,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,cljs.core.cst$kw$token)){
var G__24271 = pattern;
switch (G__24271) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24271)].join('')));
...
return p1__24273_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__24274_SHARP_){
return p1__24274_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__24275_SHARP_){
return p1__24275_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__24276_SHARP_){
return p1__24276_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__24277_SHARP_){
return p1__24277_SHARP_.getHours();
});

break;
case "day":
return (function (p1__24278_SHARP_){
return p1__24278_SHARP_.getDate();
});

break;
case "month":
return (function (p1__24279_SHARP_){
return p1__24279_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__24280_SHARP_){
return p1__24280_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24281__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__24283){
...
var key = first__24286;
var args = seq__24285__$1;
var G__24287 = key;
...
break;
case "ordinal-suffix":
var vec__24288 = (function (){var G__24291 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__24291) : syntax_list.call(null,G__24291));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24287__$1)].join('')));
...
var d = value;
var G__24296 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__24297 = G__24296;
var seq__24298 = cljs.core.seq(vec__24297);
var first__24299 = cljs.core.first(seq__24298);
var seq__24298__$1 = cljs.core.next(seq__24298);
var unparser = first__24299;
var more = seq__24298__$1;
var s = "";
var d__$1 = d;
var G__24296__$1 = G__24296;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__24306 = G__24296__$1;
var seq__24307 = cljs.core.seq(vec__24306);
var first__24308 = cljs.core.first(seq__24307);
var seq__24307__$1 = cljs.core.next(seq__24307);
var unparser__$1 = first__24308;
var more__$1 = seq__24307__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__24309 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24309,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24309,(1),null);
var G__24312 = d__$3;
var G__24313 = more__$1;
var G__24314 = s__$3;
d__$1 = G__24312;
G__24296__$1 = G__24313;
s__$1 = G__24314;
continue;
}
break;
